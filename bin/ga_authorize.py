...
kl = KennyLoggins()
logger = kl.get_logger(_APP_NAME, "ga_authorize_endpoint", logging.INFO)


class ga_authorize(splunk.rest.BaseRestHandler):
    ...
    def handle_GET(self, **kwargsraw):
        try:
            ...
            gapps_oauth_scope = ['https://www.googleapis.com/auth/admin.reports.audit.readonly',  # ADMIN SDK REPORTS
                                 ...
                                 'https://www.googleapis.com/auth/admin.directory.user.readonly',  # Directory Reading.
                                 'https://www.googleapis.com/auth/admin.directory.device.chromeos.readonly',  # chromeos
                                 'https://www.googleapis.com/auth/drive.metadata.readonly',  # READONLY DRIVE METADATA
