...
require([
    ...
    "asa_config",
    "splunkjs/ready!",
    "splunkjs/mvc/simplexml/ready!" ,"asa_mi_ga","asa_mi_ga_ss","asa_mi_ga_bigquery","asa_mi_ga_classroom", 
 "asa_proxy", 
 "asa_credential", 
 "asa_readme", 
 "asa_z_appconfig_authorize"
             ...
             configManager,
             mvc,
             ignored , asa_mi_ga, asa_mi_ga_ss, asa_mi_ga_bigquery, asa_mi_ga_classroom,
    asa_proxy,
    asa_credential,
    asa_readme,
    asa_z_appconfig_authorize
    ...
    var miMan_ga = new asa_mi_ga();var miMan_ga_ss = new asa_mi_ga_ss();var miMan_ga_bigquery = new asa_mi_ga_bigquery();var miMan_ga_classroom = new asa_mi_ga_classroom();
